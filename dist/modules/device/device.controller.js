...
export const getDeviceStatus = async (req, reply) => {
...
export const loadPath = async (req, reply, app) => {
    const { pathId, id } = req.body;
...
export const startGame = async (req, reply, app) => {
    const { pathId, deviceId, deviceSecret } = req.body;
...
export const pauseGame = async (req, reply, app) => {
...
export const resumeGame = async (req, reply, app) => {
    const { deviceId, deviceSecret } = req.body;
    const topic = `devices/${deviceId}/${deviceSecret}/cmd`;
    const cmd = {
        type: "resume_game",
...
export const endGame = async (req, reply, app) => {
    const { deviceId, deviceSecret } = req.body;
    const topic = `devices/${deviceId}/${deviceSecret}/cmd`;
    const cmd = {
        type: "end_game",
